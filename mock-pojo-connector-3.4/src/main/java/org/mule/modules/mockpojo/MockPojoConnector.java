 ...
 * @author MuleSoft, Inc.
 */
@Connector(name = "mockpojo", description = "Mock Pojo Connector", friendlyName = "Mock Pojo Connector", schemaVersion = "1.0-SNAPSHOT", minMuleVersion = "3.4")
public class MockPojoConnector
{
     ...
     * Get items;
     * <p/>
     * {@sample.xml ../../../doc/mock-pojo-connector.xml.sample mockpojo:operationRemovedInNewerVersion}
     *
     * @return foobar
     */
    @Processor
    public Object operationRemovedInNewerVersion()
    {
        return "foobar";
    }
